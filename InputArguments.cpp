...
int main(int argc, char *argv[])
{
    ...
    opt::options_description desc("Application flags");
    ...
    desc.add_options()
        ...
        ("apples,a", opt::value<int>()->default_value(50), "how many apples do you have")
        //passing value directly to variable, also making oranges flag required
